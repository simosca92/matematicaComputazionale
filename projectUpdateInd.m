...
(* :Context: Introduzione all insiemistica
 ...
 :Sources:   biblio *)
	...
	gameApp::usage = "gameApp[] semplice funzione che rappresenta graficamente il concetto di appartenenza"
	gameInter::usage = "gameInter[] semplice funzione che rappresenta graficamente il concetto di intersezione."
	gameApp2::usage = "gameApp2[] semplice funzione che rappresenta graficamente il concetto di appartenenza."
	gameDiff::usage = "gameDiff[] semplice funzione che rappresenta graficamente il concetto di differenza."
	game1::usage = "game1[] semplice funzione che rappresenta graficamente il concetto di insieme."
	gamePart::usage = "gamePart[] semplice funzione che rappresenta graficamente il concetto di partizione."
    gameUnion::usage = "gameUnion[] semplice funzione che rappresenta graficamente il concetto di unione."
    gameExercise1::usage = "gameExercise1[] semplice funzione che rappresenta graficamente un esercizio sugli insiemi."
    gameExercise2::usage = "gameExercise2[] semplice funzione che rappresenta graficamente un esercizio sugli insiemi."
    gameExercise3::usage = "gameExercise3[] semplice funzione che rappresenta graficamente un esercizio sugli insiemi."
    gameExercise4::usage = "gameExercise4[] semplice funzione che rappresenta graficamente un esercizio sugli insiemi."
	Begin["`Private`"]
  		...
  		DynamicModule[{pt1 = {-34, 7}, pt2 = {-31, 7}, pt3 = {-28, 7}, pt4 = {-24, 7}, pt5 = {-20, 7}, pt6 = {-16, 7}, 
		     		...
		     		eh3[val1_, oneTimeloc_] := EventHandler[{Text[Style["12", colTwelve, Italic, 20], Dynamic@val1]}, 
						                     ...
						                     "MouseDragged" :> (If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			    			                                   ...
			    			                                   If[oneTimeloc == 1, oneTimeloc = 0; inTwelve = inTwelve + 1(*Speak["Very Bad!"];*)];
          ...
          gameExercise2[] := (
		           ...
		           Grid[{{Button["Valuta!", If[ok1 == 1 && ok2 == 1 && ok3 == 1 && ok4 == 1 && ok5 == 1 && 
		      		    ...
		      		    Button["Reset!",pt1 = {-36, 6}; pt2 = {-24, 6}; pt3 = {-35, 3}; pt4 = {-27, 3}; pt5 = {-7, 6}; 
		    		                     ...
		    		                     inMauro = 0; inCate = 0; oneTime = 1; oneTimeOut = 1; init = 1; init1 = 1; init2 = 1; init3 = 1; i
