...
(* :Context: Introduzione all insiemistica
 ...
 :Sources:   biblio *)
    ...
    gameExercise1::usage = "gameExercise1[] semplice funzione che rappresenta graficamente il concetto di aggregazione"
    gameExercise2::usage = "gameExercise2[] semplice funzione che rappresenta graficamente il concetto di aggregazione"
    gameExercise3::usage = "gameExercise3[] semplice funzione che rappresenta graficamente il concetto di aggregazione"
    gameExercise4::usage = "gameExercise4[] semplice funzione che rappresenta graficamente il concetto di aggregazione"
	Begin["`Private`"]
		...
		gameUnion[] := (
  		DynamicModule[{pt1 = {-34, 7}, pt2 = {-31, 7}, pt3 = {-28, 7}, pt4 = {-24, 7}, pt5 = {-20, 7}, pt6 = {-16, 7}, 
		     	...
		     	eh[val1_, oneTimeloc_] := 
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt1), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , val1 = MousePosition["Graphics"]];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt2), 
						"MouseDragged" :> ( 
		  ...
		  \
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inSix == 2, colSix = Red; colSix1 = Red; ok1 = 1];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt3), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {-1, 31}; colNine = Red; 
			    ok5 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt4), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
		...
		intersezione*)
		      ...
		      EventHandler[{Text[Style["15", colFifteen, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt5), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {-3, 26}; colFifteen = Red; 
			    ok6 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt6), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inEighteen == 2, colEighteen = Red; 
			     colEighteen1 = Red;
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt7), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inSix == 2, colSix1 = Red; colSix = Red; ok1 = 1];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt8), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {-4, 31}; colEight = Red; 
			    ok7 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt9), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {2, 31}; colTen = Red; 
			    ok8 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
			 			 ...
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt10), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {10, 31}; colFuorteen = Red; 
			    ok9 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
		      ...
		      EventHandler[{Text[Style["16", colSixteen, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt11), 
		    ...
		    \
			   ...
			   If[oneTimeloc == 1,oneTimeloc = 0; val1 = {1, 26}; colSixteen = Red; 
			    ok10 = 1(*Speak[
			    			    "Very Bad!"];*)]]
			  			  )
						}];
		      ...
		      EventHandler[{Text[Style["12", colTwelve1, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt12), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
		      ...
		      EventHandler[{Text[Style["18", colEighteen1, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt13), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
		...
		DynamicModule[{pt1 = {-34, 7}, pt2 = {-31, 7}, pt3 = {-28, 7}, 
		   ...
		   Row[{
			 ...
			 l1 = Line[{{-40, 13}, {-35, 1}, {-15, 1}, {-10, 13}, {-40, 
			     13}}], Red,
			 l2 = 
			  Line[{{-15, 36}, {-10, 22}, {10, 22}, {15, 36}, {-15, 36}}],
			  Black,
		...
		gameDiff[] :=(
		   ...
		   Initialization :> (testpoint[poly_, pt_] := 
		     ...
		     eh3b[val1_, oneTimeloc_] := 
		      EventHandler[{Text[Style["3", colThree, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt3b),
			"MouseDragged" :> (If[oneTimeloc == 1, 
			    val1 = MousePosition["Graphics"];]
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt6b), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		     ...
		     eh9b[val1_, oneTimeloc_] := 
		      EventHandler[{Text[Style["9", colNine, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt9b), 
			"MouseDragged" :> (If[oneTimeloc == 1, 
			    val1 = MousePosition["Graphics"];]
		...
		intersezione*) 
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt12b), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
		     ...
		     eh15b[val1_, oneTimeloc_] := 
		      EventHandler[{Text[Style["15", colFifteen, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt15b), 
			"MouseDragged" :> (If[oneTimeloc == 1, 
			    val1 = MousePosition["Graphics"];]
		...
		intersezione*) 
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt18b), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt6n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		     ...
		     eh8n[val1_] := 
		      EventHandler[{Text[Style["8", Black, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt8n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
		     ...
		     eh10n[val1_] := 
		      EventHandler[{Text[Style["10", Black, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt10n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt12n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
		     ...
		     eh14n[val1_] := 
		      EventHandler[{Text[Style["14", Black, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt14n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
		     ...
		     eh16n[val1_] := 
		      EventHandler[{Text[Style["16", Black, Italic, 20], 
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt16n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		intersezione*)
			 ...
			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt18n), 
			"MouseDragged" :> (If[oneTimeOut == 1, 
			   val1 = MousePosition["Graphics"];, 
			   If[oneTimeOut == 0, oneTimeOut = 1];];
		...
		game1[] := (DynamicModule[{pt1 = {RandomInteger[{-35, 35}], 
		   ...
		   Initialization :> (
			 ...
			 5]}, {"MouseClicked" :> (val1 = {RandomInteger[{-35, 35}], RandomInteger[{15, 35}]}), 
			"MouseDragged" :> (If[ inMela == 0 && oneTimeOut == 1 , 
			 ...
			 5]}, {"MouseClicked" :> (val = {RandomInteger[{-35, 35}], RandomInteger[{15, 35}]}), 
			"MouseDragged" :> (If[ inBanana == 0 && oneTimeOut == 1, 
			 ...
			 5]}, {"MouseClicked" :> (val2 = {RandomInteger[{-35, 35}], RandomInteger[{15, 35}]}), 
		   ...
		   Manipulate[
		    ...
		    Button["Valuta!", 
		     If[ok1 == 1 && ok2 == 1 && ok3 == 1 && ok4 == 1 && ok5 == 1 && 
		      ...
		      Speak["Very good"], Speak["You can do better"]]], Button["Reset!",pt1 = {-10, 8}; pt2 = {-7, 8}; pt3 = {-4, 8}; 
		    pt4 = {-1, 8}; pt5 = {2, 8}; pt6 = {5, 8}; pt7 = {8, 8}; 
		    pt8 = {11, 8}; pt9 = {-1, 4};pt10 = {2, 4};init1 = 1; 
		    init2 = 1; init3 = 1; init4 = 1; init5 = 1; init6 = 1; init7 = 1; 
		    init8 = 1; init9 = 1;init10 = 1; colOne = Red; colTwo = Red; 
		    colThree = Red; colFour = Red; colFive = Red; colSix = Red; 
		    colSeven = Red; colEight = Red; colNine = Red; colTen = Red; 
...
gameExercise1[] := (
  		DynamicModule[{pt1 = {-36, 6}, pt2 = {-24, 6}, pt3 = {-35, 3}, 
		    ...
		    eh5, eh6,
		    		     eh7, eh8, eh9, eh10, eh11, eh12, l1, l2, l3, l4,l5, 
		    		    inMauro = 0, inCate = 0, oneTime = 1, oneTimeOut = 1, 
		    prec, 
		    		    init = 1, init1 = 1, init2 = 1, init3 = 1, init4 = 1, 
		    init5 = 1, init6 = 1, init9 = 1, init15 = 1, init10 = 1, 
		    init16 = 1,
		    		    init8 = 1, init14 = 1,
		colMauro=Blue,colCate=Blue,colMauro2=Black,colCate2=Black,
...
colMauro2=Black;colCate2=Black;   ok1 = 0; ok2 = 0; ok3 = 0; ok4 = 0; ok5 = 0; ok6 = 0;   ok7 = 0;ok8 = 0; ok9 = 0; ok10 = 0],Button["Suggerimento",MessageDialog[Style["L'operazione da fare \[EGrave]: (A\[Intersection]B)",Bold,Large]]],SpanFromLeft}},Alignment->Center]],
		   		   ...
		   		   Initialization :> (
		     		     ...
		     		     eh[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Mauro", colMauro, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt1), 
...
If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    			    ...
			    			    If[oneTimeloc == 1, oneTimeloc = 0; 
			     			     inMauro = inMauro + 1(*Speak["Very Bad!"];*)];
			    ...
			    If[inMauro == 2, colMauro = Red; colMauro2 = Red; ok1 = 1];
		     		      ...
		     		      eh1[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Caterina", colCate, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt2), 
						"MouseDragged" :> ( If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme unione*)
			    			    ...
			    			    If[oneTimeloc == 1, oneTimeloc = 0; 
			     			     inCate = inCate + 1(*Speak["Very Bad!"];*)];
		     		      ...
		     		      eh2[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Luca", Blue, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (pt3), 
			   ...
			   val1 = {-35, 3};]
		     		      ...
		     		      eh3[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Giacomo", Blue, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (pt4), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
		      ...
		      EventHandler[{Text[Style["Luigi", Black, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt5), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
			   ...
			   val1 = {-7, 6}; ]
		     		       ...
		     		       eh5[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Caterina", colCate2, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt6), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inCate == 2, colCate = Red; 
			     colCate2 = Red;
		     		      ...
		     		      eh6[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Mauro", colMauro2, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt7), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inMauro == 2, colMauro = Red; colMauro2 = Red; ok1 = 1];
		     		       ...
		     		       eh7[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Marco", Black, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt8), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
			   ...
			   val1 = {4, 3};]
		     		       ...
		     		       eh8[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Carlo", Green, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt9), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
			   ...
			   val1 = {23, 6}; ]
		     		     ...
		     		     eh9[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Federico", Green, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt10), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
		      ...
		      EventHandler[{Text[Style["Elisa", Green, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt11), 
...
gameExercise2[] := (
  		DynamicModule[{pt1 = {-36, 6}, pt2 = {-24, 6}, pt3 = {-35, 3}, 
		    ...
		    init16 = 1,
		    		    init8 = 1, init14 = 1,
		colMauro=Blue,colCate=Blue,colMauro2=Black,colCate2=Black,colLuca = Blue,colGiac = Blue,colLuigi = Black,colMarco = Black,colCarlo = Green,colFederico = Green,colElisa = Green,
		    		    ok1 = 0, ok2 = 0, ok3 = 0, ok4 = 0, ok5 = 0, ok6 = 0, 
		    ok7 = 0, ok8 = 0, ok9 = 0, ok10 = 0},
...
If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inMauro == 2, colMauro = Red; colMauro2 = Red; ok1 = 1];
						...
						"MouseDragged" :> ( If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
		     		      ...
		     		      eh2[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Luca", colLuca, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt3), 
			   ...
			   val1 = {10, 34};colLuca = Red;ok3=1;oneTimeloc =0;]
		     		      ...
		     		      eh3[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Giacomo", colGiac, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt4), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
		      ...
		      EventHandler[{Text[Style["Luigi", colLuigi, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt5), 
		...
		intersezione*)
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
			    ...
			    If[inMauro == 2, colMauro = Red; colMauro2 = Red; ok1 = 1];
		     		       ...
		     		       eh7[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Marco", colMarco, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt8), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
			   ...
			   val1 = {8, 30};colMarco = Red;ok6 = 1;oneTimeloc = 0;]
		     		       ...
		     		       eh8[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Carlo",colCarlo, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt9), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 ,
			   ...
			   val1 = {-8, 26};colCarlo = Red;ok7=1;oneTimeloc =0; ]
		     		     ...
		     		     eh9[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Federico", colFederico, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt10), 
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 ,
		      ...
		      EventHandler[{Text[Style["Elisa", colElisa, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt11), 
		...
		colGiacomo=Blue,colLuca=Blue,
		    ...
		    init16 = 1;    init8 = 1; init14 = 1;colLuca=Blue;colGiacomo=Blue;   ok1 = 0; ok2 = 0; ok3 = 0; ok4 = 0; ok5 = 0; ok6 = 0;   ok7 = 0;ok8 = 0; ok9 = 0; ok10 = 0],Button["Suggerimento",MessageDialog[Style["L'operazione da fare \[EGrave]: A\(A\[Intersection]B)",Bold,Large]]],SpanFromLeft}},Alignment->Center]],
		   		   ...
		   		   Initialization :> (
		     		     ...
		     		     eh[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Mauro", Blue, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt1), 
...
If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
		     		      ...
		     		      eh1[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Caterina", Blue, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt2), 
						"MouseDragged" :> ( If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme unione*)
			  ...
			  If[oneTimeloc == 1, oneTimeloc = 0; 
			   ...
			   colLuca = Red; 
			      ok1 = 1
		     		      ...
		     		      eh3[val1_, oneTimeloc_] := 
		      		     EventHandler[{Text[Style["Giacomo", colGiacomo, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt4), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
			...
			"MouseDragged" :> (If[ oneTimeloc == 1 , 
			   ...
			   val1 = {-7, 6}; ]
		     		       ...
		     		       eh5[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Caterina", Black, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt6), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
		intersezione*)
			   ...
			   If[val1[[2]] > 23 && val1[[1]] > -15 && val1[[1]] < 15 ,
		     		      ...
		     		      eh6[val1_, oneTimeloc_] := 
		      		      EventHandler[{Text[Style["Mauro", Black, Italic, 20], 
			 			 Dynamic@val1]}, {"MouseClicked" :> (val1 = pt7), 
						"MouseDragged" :> ( 
			  			  If[oneTimeloc == 1, val1 = MousePosition["Graphics"];]
			   			   (*se inserisco il numero sei nell'insieme \
...
gameExercise4[] := (
  		DynamicModule[{pt1 = {-36, 6}, pt2 = {-24, 6}, pt3 = {-35, 3}, 
		    ...
		    init16 = 1,
		    		    init8 = 1, init14 = 1,
		colGiacomo=Blue,colLuca=Blue,colLuigi=Black, colMarco=Black,
		    		    ok1 = 0, ok2 = 0, ok3 = 0, ok4 = 0, ok5 = 0, ok6 = 0, 
		    ok7 = 0, ok8 = 0, ok9 = 0, ok10 = 0},
